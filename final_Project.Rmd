...
output$plot2 <- renderPlotly({
                  p = ggplot(ProcessDF(input$file), aes_string(x = "normTime", y = input$waveform)) + geom_line() + xlab("Normalized Time (sec)") + geom_vline(xintercept =  c(0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300), color = "blue", linetype = "dashed") 
                  print(p)
                })
